...
class ErrorCode(StrEnum):
    ...
    WORKORDER_ALREADY_COMPLETED = "WORKORDER_ALREADY_COMPLETED"
    WORKORDER_REGION_MISMATCH = "WORKORDER_REGION_MISMATCH"
    WORKORDER_TOTAL_GRIDS_MISMATCH = "WORKORDER_TOTAL_GRIDS_MISMATCH"
    WORKORDER_PROGRESS_EXCEEDS_TOTAL = "WORKORDER_PROGRESS_EXCEEDS_TOTAL"
    SUBMISSION_NOT_CHECKED_OUT = "SUBMISSION_NOT_CHECKED_OUT"
    ATTACHMENT_REQUIRED = "ATTACHMENT_REQUIRED"
    ACTIVE_ATTACHMENT_ALREADY_EXISTS = "ACTIVE_ATTACHMENT_ALREADY_EXISTS"
