...
from app.schemas.submissions import CreateSubmissionRequest, SubmissionResponse, UpdateSubmissionRequest
...
async def create_submission(
    ...
    submission = await service.create_submission(auth_payload, payload)
